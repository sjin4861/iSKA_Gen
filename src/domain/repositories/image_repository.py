...
class ImageRepository(ABC):
    """image_caption 후보를 제공하는 추상 포트"""
    
    # TODO: [ARCHITECTURE] 다음 메서드들을 domain/usecases/image/로 분리 필요:
    # - generate_and_fill_missing -> GenerateAndFillMissingImageCaptionsUseCase
    # - generate_one -> GenerateOneImageCaptionUseCase  
    # - find -> FindImageCaptionsUseCase
