...
base_path = "/home/sjin4861/25-1/HCLT/iSKA_Gen/src/data/pairwise_data/v3/imp"
output_dir = "/home/sjin4861/25-1/HCLT/iSKA_Gen/src/data/rm_training/imp/2025-08-02"
...
for rubric, data in rubric_data.items():
    output_filename = os.path.join(output_dir, f"IMP_{rubric}_{today_str}.json")
